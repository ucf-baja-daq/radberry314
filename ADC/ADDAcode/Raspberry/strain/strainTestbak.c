...
int  main()
{
   ...
   printf("ID=\r\n");  
	...
	FILE *data = fopen("/home/pi/Desktop/daq/data/adc/ADC_Data.txt", "w");
	...
	for (i = 0; i < 50; i++) {
			// current_time = difftime(time(NULL), init_time);
		...
		//bsp_DelayUS(100000);	
            ...
            //printf("%ld, -%ld.%03ld%03ld\n", current_time, iTemp /1000000, (iTemp%1000000)/1000, iTemp%1000);
            // fprintf(data, "%ld, -%ld.%03ld%03ld\n", current_time, iTemp /1000000, (iTemp%1000000)/1000, iTemp%1000);
            // fflush(data);
	}
